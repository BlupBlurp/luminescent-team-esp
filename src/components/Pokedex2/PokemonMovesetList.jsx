...
export const TYPE_COLOR_MAP = {
  ...
  1: { name: 'Lucha', color: '#ce436a', iconFilename: 'Fighting.webp' },
  2: { name: 'Volador', color: '#8caadc', iconFilename: 'Flying.webp' },
  3: { name: 'Veneno', color: '#ac66c8', iconFilename: 'Poison.webp' },
  4: { name: 'Tierra', color: '#d97946', iconFilename: 'Ground.webp' },
  5: { name: 'Roca', color: '#c7b887', iconFilename: 'Rock.webp' },
  6: { name: 'Bicho', color: '#90c127', iconFilename: 'Bug.webp' },
  7: { name: 'Fantasma', color: '#4e6caa', iconFilename: 'Ghost.webp' },
  8: { name: 'Acero', color: '#518ea3', iconFilename: 'Steel.webp' },
  9: { name: 'Fuego', color: '#ff9d54', iconFilename: 'Fire.webp' },
  10: { name: 'Agua', color: '#4f92d6', iconFilename: 'Water.webp' },
  11: { name: 'Planta', color: '#65bd55', iconFilename: 'Grass.webp' },
  12: { name: 'Eléctrico', color: '#fad143', iconFilename: 'Electric.webp' },
  13: { name: 'Psíquico', color: '#f97175', iconFilename: 'Psychic.webp' },
  14: { name: 'Hielo', color: '#72cfbd', iconFilename: 'Ice.webp' },
  15: { name: 'Dragón', color: '#116ac4', iconFilename: 'Dragon.webp' },
  16: { name: 'Siniestro', color: '#5b5464', iconFilename: 'Dark.webp' },
  17: { name: 'Hada', color: '#eb92e4', iconFilename: 'Fairy.webp' },
};
